...
namespace HekaMiniumApi.Migrations
{
    ...
    [Migration("20230313135454_projectInvoiceStatus")]
    partial class projectInvoiceStatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HekaMiniumApi.Context.CurrentAccountReceipt", b =>
                {
                    ...
                    b.ToTable("CurrentAccountReceipt");
                });

            modelBuilder.Entity("HekaMiniumApi.Context.CurrentAccountReceiptDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("CurrentAccountReceiptId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CurrentAccountReceiptId");

                    b.HasIndex("ExpenseId");

                    b.ToTable("CurrentAccountReceiptDetail");
                });
            ...
            modelBuilder.Entity("HekaMiniumApi.Context.Employee", b =>
                {
                    ...
                    b.Property<decimal?>("EmployeeHourlyWage")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("HekaMiniumApi.Context.ExpenseCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HekaMiniumApi.Context.FirmPeriodStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HekaMiniumApi.Context.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool?>("EInvoiceStatus")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("HekaMiniumApi.Context.InvoiceReceiptDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("ItemReceiptDetailId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HekaMiniumApi.Context.ItemDemandDetailPart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ItemDemandDetailPart");
                });
            ...
            modelBuilder.Entity("HekaMiniumApi.Context.WorkingPeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HekaMiniumApi.Context.CurrentAccountReceipt", b =>
                {
                    ...
                    b.HasOne("HekaMiniumApi.Context.WorkingPeriod", "WorkingPeriod")
                        .WithMany()
            ...
            modelBuilder.Entity("HekaMiniumApi.Context.CurrentAccountReceiptDetail", b =>
                {
                    b.HasOne("HekaMiniumApi.Context.CurrentAccountReceipt", "CurrentAccountReceipt")
                        .WithMany()
                        .HasForeignKey("CurrentAccountReceiptId");

                    b.HasOne("HekaMiniumApi.Context.ExpenseCard", "ExpenseCard")
                        .WithMany()
                        .HasForeignKey("ExpenseId");

                    b.Navigation("CurrentAccountReceipt");

                    b.Navigation("ExpenseCard");
                });
            ...
            modelBuilder.Entity("HekaMiniumApi.Context.InvoiceReceiptDetail", b =>
                {
                    b.HasOne("HekaMiniumApi.Context.Invoice", "Invoice")
                        .WithMany()
                        .HasForeignKey("InvoiceId");

                    b.HasOne("HekaMiniumApi.Context.ItemReceiptDetail", "ItemReceiptDetail")
                        .WithMany()
            ...
            modelBuilder.Entity("HekaMiniumApi.Context.ItemDemandDetailPart", b =>
                {
                    b.HasOne("HekaMiniumApi.Context.ItemDemandDetail", "ItemDemandDetail")
                        .WithMany("ItemDemandDetailParts")
                        .HasForeignKey("ItemDemandDetailId");
            ...
            modelBuilder.Entity("HekaMiniumApi.Context.ItemDemandDetail", b =>
                {
                    b.Navigation("ItemDemandDetailParts");

                    b.Navigation("ItemDemandProcesses");
